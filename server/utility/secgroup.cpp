...
//=========================================================
auto secgroup_t::type(const std::string &type) ->std::map<std::string, section_t>* {
	auto iter = _section_types.find(type);
	if (iter != _section_types.end()){
		return &iter->second;
	}
...
//=========================================================
auto secgroup_t::type(const std::string &type) const ->const std::map<std::string, section_t>* {
	auto iter = _section_types.find(type);
	if (iter != _section_types.end()){
		return &iter->second;
	}
...
auto secgroup_t::raw() const ->const std::map<std::string,std::map<std::string,section_t> >& {
