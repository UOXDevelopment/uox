...
const std::unordered_map<language_t,std::string> language_names  {
	{language_t::none,"none"s}, 		{language_t::english,"english"s}, 	{language_t::german,"german"s},
	{language_t::spanish,"spanish"s}, 	{language_t::french,"french"s}, 	{language_t::portuguese,"portuguese"s},
	{language_t::italian,"italian"s}, 	{language_t::czech,"czech"s}, 	{language_t::polish,"polish"s},
	{language_t::russian,"russian"s}, 	{language_t::japanese,"japanese"s}
} ;
//=========================================================
...
const std::unordered_map<unicode_t,language_t> unicodelang_map {
	{unicode_t::ZERO, language_t::none},	{unicode_t::ARA, language_t::none},		{unicode_t::ARI, language_t::none},
	{unicode_t::ARE, language_t::none}, 	{unicode_t::ARL, language_t::none}, 	{unicode_t::ARG, language_t::none},
	{unicode_t::ARM, language_t::none}, 	{unicode_t::ART, language_t::none}, 	{unicode_t::ARO, language_t::none},
	{unicode_t::ARY, language_t::none}, 	{unicode_t::ARS, language_t::none}, 	{unicode_t::ARJ, language_t::none},
	{unicode_t::ARB, language_t::none},		{unicode_t::ARK, language_t::none}, 	{unicode_t::ARU, language_t::none},
	{unicode_t::ARH, language_t::none},		{unicode_t::ARQ, language_t::none}, 	{unicode_t::BGR, language_t::none},
	{unicode_t::CAT, language_t::none}, 	{unicode_t::CHT, language_t::none}, 	{unicode_t::CHS, language_t::none},
	{unicode_t::ZHH, language_t::none}, 	{unicode_t::ZHI, language_t::none}, 	{unicode_t::ZHM, language_t::none},
	{unicode_t::CSY, language_t::czech}, 	{unicode_t::DAN, language_t::none}, 	{unicode_t::DEU, language_t::german},
	{unicode_t::DES, language_t::german}, 	{unicode_t::DEA, language_t::german}, 	{unicode_t::DEL, language_t::german},
	{unicode_t::DEC, language_t::german},	{unicode_t::ELL, language_t::none}, 	{unicode_t::ENU, language_t::english},
	{unicode_t::ENG, language_t::english}, 	{unicode_t::ENA, language_t::english}, 	{unicode_t::ENC, language_t::english},
	{unicode_t::ENZ, language_t::english}, 	{unicode_t::ENI, language_t::english}, 	{unicode_t::ENS, language_t::english},
	{unicode_t::ENJ, language_t::english}, 	{unicode_t::ENB, language_t::english}, 	{unicode_t::ENL, language_t::english},
	{unicode_t::ENT, language_t::english}, 	{unicode_t::ENW, language_t::english}, 	{unicode_t::ENP, language_t::english},
	{unicode_t::ESP, language_t::spanish}, 	{unicode_t::ESM, language_t::spanish}, 	{unicode_t::ESN, language_t::spanish},
	{unicode_t::ESG, language_t::spanish}, 	{unicode_t::ESC, language_t::spanish}, 	{unicode_t::ESA, language_t::spanish},
	{unicode_t::ESD, language_t::spanish}, 	{unicode_t::ESV, language_t::spanish}, 	{unicode_t::ESO, language_t::spanish},
	{unicode_t::ESR, language_t::spanish}, 	{unicode_t::ESS, language_t::spanish}, 	{unicode_t::ESF, language_t::spanish},
	{unicode_t::ESL, language_t::spanish}, 	{unicode_t::ESY, language_t::spanish}, 	{unicode_t::ESZ, language_t::spanish},
	{unicode_t::ESB, language_t::spanish}, 	{unicode_t::ESE, language_t::spanish}, 	{unicode_t::ESH, language_t::spanish},
	{unicode_t::ESI, language_t::spanish}, 	{unicode_t::ESU, language_t::spanish}, 	{unicode_t::FIN, language_t::none},
	{unicode_t::FRA, language_t::french}, 	{unicode_t::FRB, language_t::french}, 	{unicode_t::FRC, language_t::french},
	{unicode_t::FRS, language_t::french}, 	{unicode_t::FRL, language_t::french}, 	{unicode_t::FRM, language_t::french},
	{unicode_t::HEB, language_t::none}, 	{unicode_t::HUN, language_t::none}, 	{unicode_t::ISL, language_t::none},
	{unicode_t::ITA, language_t::italian}, 	{unicode_t::ITS, language_t::italian}, 	{unicode_t::JPN, language_t::japanese},
	{unicode_t::KOR, language_t::none}, 	{unicode_t::NLD, language_t::none}, 	{unicode_t::NLB, language_t::none},
	{unicode_t::NOR, language_t::none}, 	{unicode_t::NON, language_t::none}, 	{unicode_t::PLK, language_t::polish},
	{unicode_t::PTB, language_t::portuguese}, {unicode_t::PTG, language_t::portuguese}, {unicode_t::ROM, language_t::none},
	{unicode_t::RUS, language_t::russian}, 	{unicode_t::HRV, language_t::none}, 	{unicode_t::SRL, language_t::none},
	{unicode_t::SRB, language_t::none}, 	{unicode_t::SKY, language_t::none}, 	{unicode_t::SQI, language_t::none},
	{unicode_t::SVE, language_t::none}, 	{unicode_t::SVF, language_t::none}, 	{unicode_t::THA, language_t::none},
	{unicode_t::TRK, language_t::none}, 	{unicode_t::URP, language_t::none}, 	{unicode_t::IND, language_t::none},
	{unicode_t::UKR, language_t::none}, 	{unicode_t::BEL, language_t::none}, 	{unicode_t::SLV, language_t::none},
	{unicode_t::ETI, language_t::none}, 	{unicode_t::LVI, language_t::none}, 	{unicode_t::LTH, language_t::none},
	{unicode_t::LTC, language_t::none}, 	{unicode_t::FARR, language_t::none}, 	{unicode_t::VIT, language_t::none},
	{unicode_t::HYE, language_t::none}, 	{unicode_t::AZE, language_t::none}, 	{unicode_t::EUQ, language_t::none},
	{unicode_t::MKI, language_t::none}, 	{unicode_t::AFK, language_t::none}, 	{unicode_t::KAT, language_t::none},
	{unicode_t::FOS, language_t::none}, 	{unicode_t::HIN, language_t::none}, 	{unicode_t::MSL, language_t::none},
	{unicode_t::MSB, language_t::none}, 	{unicode_t::KAZ, language_t::none}, 	{unicode_t::SWK, language_t::none},
	{unicode_t::UZB, language_t::none}, 	{unicode_t::TAT, language_t::none}, 	{unicode_t::BEN, language_t::none},
	{unicode_t::PAN, language_t::none}, 	{unicode_t::GUJ, language_t::none}, 	{unicode_t::ORI, language_t::none},
	{unicode_t::TAM, language_t::none}, 	{unicode_t::TEL, language_t::none}, 	{unicode_t::KAN, language_t::none},
	{unicode_t::MAL, language_t::none}, 	{unicode_t::ASM, language_t::none}, 	{unicode_t::MAR, language_t::none},
